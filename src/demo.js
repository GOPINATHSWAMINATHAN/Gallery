!function t(e, i, n) {
    ...
    1: [function (t, e, i) {
        !function (i, n) {
            ...
            function o(t) {
                var e = [];
                if (s(t)) e = t; else if ("number" == typeof t.length) for (var i = 0; i < t.length; i++) e.push(t[i]); else e.push(t);
                return e
            }
            ...
            var a = t.jQuery, u = t.console, c = Object.prototype.toString;
        ...
        !function (t) {
            ...
            var s = document.documentElement, o = function () {
            };
        ...
        (function () {
            ...
            var s = t.prototype, o = this, r = o.EventEmitter;
            s.getListeners = function (t) {
                ...
                var n, s = this.getListenersAsObject(t), o = "object" == typeof e;
        ...
        !function (t, n) {
            ...
            function e() {
                ...
                var c = t("span", n.CONTROLS_BTN), f = t("span", n.CONTROLS_BTN), m = t("span", n.CONTROLS_BTN);
        ...
        !function (n, s) {
            ...
            }, o = !1, r = "transform", l = "Webkit Moz ms".split(" "), h = "", a = document.createElement("div");
            ...
            return s.prototype._cssClasses = {
                ...
                var i = this, s = t(document.querySelector("div[data-google-image-layout]"));
                s.on("progress", function (t, e) {
                    ...
                    var e = i._element, n = document.createElement("div");
        ...
        !function (t, n) {
            ...
            return e.init = function (t) {
                ...
                var e = t.clientWidth, i = parseInt(t.getAttribute("data-max-height") || 120),
                    l = s(t.querySelectorAll("img"));
                t:for (; l.length > 0;) {
                    for (var h = 1; h <= l.length; h++) {
                        var a = l.slice(0, h), u = o(a, e, n);
                        if (i > u) {
                            r(a, u), l = l.slice(h);
                            continue t
                        }
